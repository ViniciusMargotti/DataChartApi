...
// Não cheque essas requisições
                .authorizeRequests().antMatchers("/usuarios/save","/estados","/cidades/*","/bairros/*","/authenticate","/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/**", "/swagger-ui.html", "/webjars/**").permitAll().
